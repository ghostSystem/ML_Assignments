...
% Last modified: 16-Oct-2018    
    ...
    methods (Static)
        function main()
            ...
            [trIds, trLbs] = ml_load('/Users/astitvnagpal/Ghost_Files/SBU/Sem1/ML/HomeWork/HW5/hw5data/bigbangtheory_v2/train.mat',  'imIds', 'lbs');             
            tstIds = ml_load('/Users/astitvnagpal/Ghost_Files/SBU/Sem1/ML/HomeWork/HW5/hw5data/bigbangtheory_v2/test.mat', 'imIds'); 
            ...
            load('trD.mat');
            load('tstD.mat');
            [trainK, testK] = cmpExpX2Kernel(trD', tstD');
        ...
        function bowCs = learnDictionary(scales, normH, normW)
            ...
            % load train ids
            trIds = ml_load('/Users/astitvnagpal/Ghost_Files/SBU/Sem1/ML/HomeWork/HW5/hw5data/bigbangtheory_v2/train.mat', 'imIds'); 
            ...
            for i=1:length(trIds);
                ...
                im = imread(sprintf('/Users/astitvnagpal/Ghost_Files/SBU/Sem1/ML/HomeWork/HW5/hw5data/bigbangtheory_v2/%06d.jpg', trIds(i)));
            ...
            [Center, ~, ~, ~] = kmeans(transpose(randWins), 1000, 20);
            bowCs = transpose(Center);
        ...
        function D = cmpFeatVecs(imIds, scales, normH, normW, bowCs)
            ...
            for i=1:n
                ...
                im = imread(sprintf('/Users/astitvnagpal/Ghost_Files/SBU/Sem1/ML/HomeWork/HW5/hw5data/bigbangtheory_v2/%06d.jpg', imIds(i)));                                
